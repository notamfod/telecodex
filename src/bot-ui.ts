  ...
  const sections = [
    {
      title: "💬 Сессия",
      commands: [
        ["/newtask", "Новая задача в отдельном топике"],
        ["/extract", "Ответьте на сообщение, чтобы вынести его в отдельную задачу"],
        ["/newchat", "Новый разговор здесь со ссылкой на предыдущий"],
        ["/topicsync", "Показать и изменить правила появления топиков"],
        ["/new", "Новая сессия в этом топике"],
        ["/task", "Создать или обновить постоянную карточку задачи в этом топике"],
        ["/session", "Текущая сессия"],
        ["/topic", "Открыть отдельный топик сессии: /topic ID"],
        ["/sessions", "Выбрать сессию; в форум-группе открыть её топик"],
        ["/switch", "Переключить сессию в текущем топике"],
        ...
        ["/attach", "Заменить привязку текущего топика: /attach ID"],
